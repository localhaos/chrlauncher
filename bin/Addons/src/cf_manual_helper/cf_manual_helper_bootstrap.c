...
#define CFM_COMMAND_LINE L"--load-extension=\"%app%\\..\\addons\\extensions\\close-tabs-right,%app%\\..\\addons\\cf_manual_helper\" --disk-cache-dir=\"%app%\\..\\Cache\" --disable-background-networking --disable-domain-reliability --disable-features=HardwareMediaKeyHandling,GlobalMediaControls"
